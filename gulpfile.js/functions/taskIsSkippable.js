...
function taskIsSkippable(filepath, data, template) {
    ...
    */
    const isCustomFunction =
        `${themePath}/middleware/customFunction.js` === store.fileModified
            ? true
            : false;
    ...
    */
    const isWrapper =
        `${templatePath}/default/_wrapper.pug` === store.fileModified
            ? true
            : false;
    ...
    */
    const includesFileIsChanged = store.includesFileMap
        .map((item) => {
    ...
    */
    ...
    const componentFileIsChanged =
        'registerComponent' in data ? componentFileChecker(data) : false;
    ...
    */
    ...
    const aditionDataIsChanged =
        'additionalData' in data ? aditionDataChecker(data) : false;

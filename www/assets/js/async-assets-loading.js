(function (factory) {
	typeof define === 'function' && define.amd ? define('asyncAssetsLoading', factory) :
	factory();
}((function () { 'use strict';

	(function (w) {
	  if (w.document.documentElement.className.indexOf('fonts-loaded') > -1) return;
	  var osRegular = new w.FontFaceObserver('opensans', {
	    weight: 400
	  }),
	  ...
	  w.Promise.all([osRegular.load(), osBold.load(), omBold.load()]).then(function () {
